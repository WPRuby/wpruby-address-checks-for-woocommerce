...
class MessageFormatter {
	...
	public static function sample_context(): array {
		return array(
			'address_type'      => __( 'Shipping address', 'address-guard-for-woocommerce' ),
			'original_address'  => '123 Main St, Springfield, IL 62701, US',
			'suggested_address' => '123 Main Street, Springfield, IL 62701, US',
			'field'             => __( 'Street address', 'address-guard-for-woocommerce' ),
			'country'           => 'US',
			'postcode'          => '62701',
			'city'              => 'Springfield',
			'rule_name'         => __( 'No PO Boxes', 'address-guard-for-woocommerce' ),
			'provider'          => 'google_address_validation',
			'validation_status' => __( 'Invalid', 'address-guard-for-woocommerce' ),
		);
	}
}
